...
export default function Petz({ ownerNFTImage }) {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-200 dark:bg-gray-900 rounded-md border border-black dark:border-white">
      ...
      {/* UPDATED: Removed fixed height h-64 and added vertical padding py-4 */}
      <div className="w-full h-auto py-4 relative bg-blue-200 dark:bg-blue-900/50 rounded-t-md overflow-hidden flex items-center justify-center">
