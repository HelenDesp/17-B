    ...
    return (
        <div className="absolute inset-0 bg-gray-200 dark:bg-gray-900 z-20 flex flex-col">
            <div className="flex justify-between items-center p-4 pb-0 mb-4">
                <p className="font-bold text-xl text-gray-800 dark:text-white">{title.toUpperCase()}</p>
                <button
...
// Add this new, dedicated ShareModal component
const ShareModal = ({ isOpen, onClose, palMojiRef, palMojiName, shareFunctions }) => {
    if (!isOpen) return null;
    ...
    return (
        <div className="absolute inset-0 z-30 flex items-center justify-center p-4 bg-transparent backdrop-blur-sm">
            <div className="relative w-full max-w-lg bg-white/80 dark:bg-gray-800/80 border-2 border-black dark:border-white p-6 flex flex-col items-center justify-center text-center">
                <button
                    onClick={onClose}
                ...
                <div className="w-full space-y-6">
                    ...
                    <div className="grid grid-cols-3 justify-items-center items-center w-full max-w-xs mx-auto gap-4">
                        {/* Share Icons */}
  ...
  return (
    <div className="flex flex-col items-center bg-gray-200 dark:bg-gray-900 rounded-md border border-black dark:border-white relative overflow-hidden">
      ...
      <ShareModal 
        ...
        palMojiRef={palMojiRef} 
        palMojiName={currentName}
        shareFunctions={{
          handleGenericShare,
          handlePlatformShare,
          handleCopyToClipboard,
