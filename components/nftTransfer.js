  ...
  {opt.label}
      ...
      <div className="mb-4">
        ...
        <input
          ...
          placeholder="0x..."
          className="w-full p-2 border border-black dark:border-white text-black dark:bg-dark-300 dark:text-white focus:border-2 focus:border-black dark:focus:border-white outline-none transition-all"
        />
      </div>
