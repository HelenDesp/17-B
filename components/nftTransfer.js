    ...
    <div className="bg-white dark:bg-dark-200 border-b2 shadow-card dark:shadow-card-dark p-6">
      <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">
		...
		<p className="text-gray-600 dark:text-gray-400 mt-2">
		  • For Single or Multiple transfers, tick the checkbox on each NFT you wish to send.<br />• For a bulk transfer of every NFT you own, simply select the "All" mode.<br /> 
		</p>
  ...
  {opt.label}
      ...
      <div className="mb-4">
        ...
        <input
          ...
          placeholder="0x..."
          className="w-full p-2 bg-white dark:bg-black text-black dark:text-white placeholder-black dark:placeholder-white focus:outline-none focus:ring-0 focus:ring-offset-0 rounded-none rvg-darkfocus"
        />
      </div>
