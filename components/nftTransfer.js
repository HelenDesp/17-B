  ...
  {opt.label}
      ...
      <div className="mb-4">
        ...
        <input
          ...
          placeholder="0x..."
          className="w-full p-2 border bg-white dark:bg-black text-black dark:text-white placeholder-black dark:placeholder-white focus:outline-none focus:ring-0 rounded-none rvg-darkfocus"
        />
      </div>
