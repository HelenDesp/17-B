              ...
              <div className="flex-grow min-w-0">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center">
                    ...
                    {/* Icon for Burned */}
                    {tx._type === "Burned" && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-5 h-5 ml-2 fill-black dark:fill-white"><path d="M216,48H176V40a24,24,0,0,0-24-24H104A24,24,0,0,0,80,40v8H40a8,8,0,0,0,0,16h8V208a16,16,0,0,0,16,16H192a16,16,0,0,0,16-16V64h8a8,8,0,0,0,0-16ZM96,40a8,8,0,0,1,8-8h48a8,8,0,0,1,8,8v8H96ZM192,208H64V64H192Zm-80-104v96a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm48,0v96a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Z"></path></svg>}
                    {/* Icon for Minted */}
                    {tx._type === "Minted" && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="w-5 h-5 ml-2 fill-black dark:fill-white"><path d="M220,132a8,8,0,0,1-8,8H148v64a8,8,0,0,1-16,0V140H68a8,8,0,0,1,0-16h64V60a8,8,0,0,1,16,0v64h64A8,8,0,0,1,220,132Z"></path></svg>}
                  </div>
                </div>
