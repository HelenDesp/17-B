          ...
          paginated.map((tx, i) => (
            <div key={i} className="text-sm text-gray-200 dark:text-gray-100 border-b border-gray-200 dark:border-gray-100 pb-2">
              <div className="flex justify-between items-center">
				...
				<div 
                  className="flex items-center justify-between text-black dark:text-white cursor-pointer"
                ...
                >
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-xs underline ml-1">({expandedIndexes[i] ? "Hide" : "Details"})</span>
                  </div>
				</div>
              {expandedIndexes[i] && (
