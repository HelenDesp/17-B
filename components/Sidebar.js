...
export default function Sidebar() {
  ...
  // --- 1. MODIFICATION: Assigned unique paths to each menu item ---
  const menuItems = [
    {
      title: "Dashboard",
      icon: (
  ...
  return (
    <div className="h-full flex flex-col bg-white border-r-2 border-dark-200 dark:bg-dark-200 dark:border-light-200 shadow-lg">
      ...
      {/* --- 2. RESTORED CORRECT NAVIGATION LOGIC --- */}
