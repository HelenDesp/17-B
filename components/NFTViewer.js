		...
		{showThankYou && (
		  <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center px-4 py-10">
			<div className="relative bg-white dark:bg-gray-800 p-10 rounded shadow-lg max-w-lg w-full text-center">
			  ...
			  {/* Close Icon */}
				<button
				  className="absolute top-4 right-4 w-10 h-10 border-2 border-black dark:border-white text-2xl font-bold text-gray-800 dark:text-white hover:bg-gray-900 hover:text-white dark:hover:bg-white dark:hover:text-black transition-all [font-family:'Cygnito_Mono',sans-serif] leading-none"
